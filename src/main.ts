...
export default class RedBeardDashboard extends Plugin {
  ...
  private registerNativeWidgets(): void {
    this.registerWidget({ id: "quick-actions", name: "Quick Actions", defaultLayout: this.layoutForId("quick-actions"), render: (_, container) => {
    ...
    this.registerWidget({ id: "modules", name: "Modules", defaultLayout: this.layoutForId("modules"), render: (_, container) => {
